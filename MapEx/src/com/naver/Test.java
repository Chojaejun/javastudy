...
public class Test {// set,map,list 중요 꼭 알아두기*******************************
	...
	public void me5(String filename) {
		...
		map.replace("txt", "텍스트파일");// Value 값 변경 map.replac
	...
	public void me1() {
		...
		System.out.println("******************************************");
		Set<String> set = map.keySet();// key는 중복이 안되니까 set으로 관리되고 있다.
		// key를 모두 출력하시오.
		Iterator<String> it = set.iterator();
		while (it.hasNext()) {
			String key = it.next();
